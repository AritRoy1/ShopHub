...
urlpatterns = [
    ...
    path('view-graph/', views.graph_Bar, name = "graph-bar"),
    
    path('update-status/<pk>/', views.update_order_status, name='update-status'),
    path('delete-status/<pk>/', views.delete_order, name='delete-status'),
    ...
    path('delivery/<int:prod_id>/', views.deliveryAddress, name = 'delivery')
